...
# Table: k8s_networking_network_policy_ingress_from_namespace_selector_match_expressions
A label selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
## Columns
| Name        | Type           | Description  |
| ------------- | ------------- | -----  |
|network_policy_ingress_from_cq_id|uuid|Unique CloudQuery ID of k8s_networking_network_policy_ingress_froms table (FK)|
