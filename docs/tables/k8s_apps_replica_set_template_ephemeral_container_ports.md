...
# Table: k8s_apps_replica_set_template_ephemeral_container_ports
ContainerPort represents a network port in a single container.
## Columns
| Name        | Type           | Description  |
| ------------- | ------------- | -----  |
|replica_set_template_ephemeral_container_cq_id|uuid|Unique CloudQuery ID of k8s_apps_replica_set_template_ephemeral_containers table (FK)|
