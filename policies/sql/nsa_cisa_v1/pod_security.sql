...
\i sql/queries/pod_security/pod_volume_host_path.sql
...
\i sql/queries/pod_security/daemonset_host_network_access_disabled.sql

\echo "Deployment container hostNetwork disabled"
\set check_id "deployment_host_network_access_disabled"
\i sql/queries/pod_security/deployment_host_network_access_disabled.sql

\echo "Job container hostNetwork disabled"
\set check_id "job_host_network_access_disabled"
\i sql/queries/pod_security/job_host_network_access_disabled.sql

\echo "Pod container hostNetwork disabled"
\set check_id "pod_container_privilege_escalation_disabled"
\i sql/queries/pod_security/pod_host_network_access_disabled.sql

\echo "ReplicaSet container hostNetwork disabled"
\set check_id "replicaset_container_privilege_escalation_disabled"
\i sql/queries/pod_security/replicaset_host_network_access_disabled.sql
...
\i sql/queries/pod_security/pod_service_account_token_disabled.sql

\echo "Service account tokens disabled"
\set check_id "service_account_token_disabled"
\i sql/queries/pod_security/service_account_token_disabled.sql
