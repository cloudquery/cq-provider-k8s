...
\i k8s/queries/network_hardening/daemonset_cpu_request.sql

\echo "Deployments enforce cpu request"
\set check_id "deployment_cpu_request"
\i k8s/queries/network_hardening/deployment_cpu_request.sql
...
\i k8s/queries/network_hardening/daemonset_memory_request.sql

\echo "Deployments enforce memory request"
\set check_id "deployment_memory_request"
\i k8s/queries/network_hardening/deployment_memory_request.sql

\echo "Jobs enforce memory request"
\set check_id "job_memory_request"
\i k8s/queries/network_hardening/job_memory_request.sql


\echo "Namespaces Memory request range default"
\set check_id "namespace_limit_range_default_memory_request"
\i k8s/queries/network_hardening/namespace_limit_range_default_memory_request.sql


\echo "Namespaces Memory request resource quota"
\set check_id "namespace_resource_quota_memory_request"
\i k8s/queries/network_hardening/namespace_resource_quota_memory_request.sql


\echo "ReplciaSets enforce cpu request"
\set check_id "replicaset_memory_request"
\i k8s/queries/network_hardening/replicaset_memory_request.sql
...
\i k8s/queries/network_hardening/network_policy_default_deny_egress.sql


\echo "Network policy default deny ingress"
\set check_id "network_policy_default_deny_ingress"
\i k8s/queries/network_hardening/network_policy_default_deny_ingress.sql

\echo "Network policy default don't allow egress"
\set check_id "network_policy_default_dont_allow_egress"
\i k8s/queries/network_hardening/network_policy_default_dont_allow_egress.sql

\echo "Network policy default don't allow ingress"
\set check_id "network_policy_default_dont_allow_ingress"
\i k8s/queries/network_hardening/network_policy_default_dont_allow_ingress.sql